...
//    스크롤 내리면 header에 active 추가
    ...
    let workData = {
        ...
        item_2:{
            videoid:"u9eehcAHhi8", 
            tit : "Motion Graphic", 
            des : "IU-LILAC Motion Graphic입니다.",
            period : "2023.11.01 ~ 2023.12.01", 
            tools : "After Effect"
            // tools에 글자말고 이미지로 넣고 싶으면 item1에 tool내용 넣으면 됨
        },
        item_3:{
            videoid:"Yu2uuyRJ2l4", 
            tit : "LIVE 2D", 
            des : "IU-LILAC LIVE 2D입니다.",
            period : "2023.11.01 ~ 2023.12.01", 
    ...
    let madalCont = document.querySelector(".modal-cont")
    ...
    pfItem.forEach(function(item,index){
        item.addEventListener("click",function(){
            ...
            madalCont.innerHTML =`<iframe src="https://www.youtube.com/embed/${obj.videoid}?autoplay=1&mute=1" allowfullscreen></iframe>`
        })
    })
